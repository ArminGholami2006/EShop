...
public class DiscountService(ApplicationContext dbContext, ILogger<DiscountService> logger) : DiscountProtoService.DiscountProtoServiceBase
{
    public override async Task<CouponModel> CreateDiscount(CreateDiscountRequest request, ServerCallContext context)
    {
        ...
        logger.LogInformation("Discount is successfully added, ProductName: {ProductName}, Amount: {Amount}", coupon.ProductName, coupon.Amount);
